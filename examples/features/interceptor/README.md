...
[`UnaryClientInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#StreamServerInterceptor)
...
To install the unary interceptor for a Server, configure `NewServer` with
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/fgiudici/grpc-go#StreamInterceptor).
