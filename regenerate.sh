...
mkdir -p ${WORKDIR}/out/github.com/fgiudici/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/fgiudici/grpc-go/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/fgiudici/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1
...
rm ${WORKDIR}/out/github.com/fgiudici/grpc-go/reflection/grpc_testingv3/*.pb.go
...
mkdir -p ${WORKDIR}/out/github.com/fgiudici/grpc-go/credentials/tls/certprovider/meshca/internal/v1/
mv ${WORKDIR}/out/istio/google/security/meshca/v1/* ${WORKDIR}/out/github.com/fgiudici/grpc-go/credentials/tls/certprovider/meshca/internal/v1/

cp -R ${WORKDIR}/out/github.com/fgiudici/grpc-go/* .
