...
import (
	...
	_ "github.com/fgiudici/grpc-go/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/fgiudici/grpc-go/internal/resolver/passthrough" // passthrough resolver.
)
